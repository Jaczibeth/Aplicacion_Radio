  ...
  return (
    ...
    >
      ...
      <View style={estilos.barraComentario}>
        <TextInput style={estilos.inputComentario} placeholder="Comentar" value={nuevoComentario}  onChangeText={setNuevoComentario}  onSubmitEditing={manejarAgregarComentario} returnKeyType="send" />
