...
const styles = StyleSheet.create({
  contenedor: { flexDirection: "row", justifyContent: "space-around", marginVertical: 10,},
  pestana: { paddingVertical: 8, paddingHorizontal: 16, borderBottomWidth: 2, borderBottomColor: "transparent",},
  pestanaActiva: { borderBottomColor: "#144784",},
  texto: { fontSize: 16,color: "#777", fontWeight: "600",},
  textoActivo: { color: "#144784",},
});