...
const estilos = StyleSheet.create({
  contenedor: {  paddingHorizontal: espaciado.normal, paddingVertical: espaciado.pequeno,},
  contenedorTarjeta: { width: 320,  marginRight: 135,},
  contenedorVacio: { flex: 1, justifyContent: "center", alignItems: "center", paddingVertical: espaciado.enorme,},
  textoVacio: { fontSize: tamanosTexto.mediano,color: colores.textoGris,  textAlign: "center",},});