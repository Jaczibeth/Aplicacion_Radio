...
export default function Noticia6({ navigation }) {
  const [saved, setSaved] = useState(false);

  const noticia = {
    categoria: "Deportes",
    titulo: "Resultados de los partidos",
    imagen:
      "https://play-lh.googleusercontent.com/Z3686VO4ILSGo_UiDPSk3i2oPf6KzCRNZhpOo5_7pTTq3JYhcUNsm1EMrK6mG_xiOBQg=w526-h296-rw",
    autor: "LuisVega",
    fecha: "9 Oct 2025",
    tiempoLectura: "4 min de lectura",
    descripcion:
      "Resumen completo de los partidos de hoy, incluyendo goles, alineaciones y estadísticas importantes.",
    contenido: [
      "Partidos destacados: Tlaxiaco FC vs Oaxaca United.",
      "Goleadores y desempeño de jugadores relevantes.",
    ],
  };
