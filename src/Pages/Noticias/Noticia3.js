...
export default function Noticia3({ navigation }) {
  ...
  const noticia = {
    categoria: "Educación media superior",
    titulo: "Fechas para Becas Rita",
    imagen:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSYUPi9vHpCfVVNXYW7owFImREiWuXEtKHCeg&s",
    autor: "Secretaría de Educación",
    fecha: "9 Oct 2025",
    tiempoLectura: "4 min de lectura",
    descripcion:
      "Se han publicado las fechas para solicitar las Becas Rita. Estudiantes interesados deben preparar su documentación.",
    contenido: [
      "Fecha límite para solicitud: 30 de octubre.",
      "Requisitos: promedio mínimo de 8.5, carta de recomendación y comprobante de estudios.",
    ],
  };
